...
const HeroImage = () => {
  ...
  const playEyeBlinkAnimation = (duration) => {
    let stepDuration = duration / 9;
    let animation = setInterval(
      () =>
        setEyeState((prev) => {
          if (prev.isDown) {
            const newSize = prev.size - 0.1;
            return {
              size: newSize,
              isDown: newSize >= 1,
            };
    ...
    setTimeout(() => clearInterval(animation), duration * 4);
  };
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 300">
      <g>
        ...
        <path
          ...
          fill="#231f20"
        ></path>
        <path d="M254.65,96.76A27.22,27.22,0,0,0,261,95.41" fill="#fff"></path>
        <path
        ...
        <path
          ...
          fill="#d1d3d4"
          className={classes["second-steam"]}
        ></path>
        <path
